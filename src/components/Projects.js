        ...
        <div className="cardInner">
          ...
          <div data-testid="bringAndShareBack" className="cardBack">
            <p className="projectPhar">
              ...
              responsible to set up the API, database, and write tests. The App
              is allow you to create and event and add on participants with
              their diatry requriments. I have created the component for adding
              participants, and the participant list with all their details.
            </p>
        ...
        <div className="cardInner">
          ...
          <div data-testid="surrealBack" className="cardBack">
            <p className="projectPhar">
              ...
              is able to log in with their Facebook account. Once logged in, you
              are able to save properties to your favourites or remove them.
            </p>
            <div className="linksCard">
              <a
                className="aCardLink"
        ...
        <div className="cardInner">
          ...
          <div data-testid="weatherBack" className="cardBack">
            <p className="projectPhar">
              ...
              cities. Once you type in the requested city it displays 5 days of
              weather forecast. By clicking on More Details, it gives you a more
              detailed description of the weather of the chosen day.
            </p>
            <div className="linksCard">
              <a
                className="aCardLink"
        ...
        <div className="cardInner">
          ...
          <div data-testid="cruiseBack" className="cardBack">
            <p className="projectPhar">
              ...
              There is a board also included which tells you the current and the
              next port. You are also able to add ports. It has been designed to
              look really oldschool. Because that is what I love the most.
            </p>
            <div className="linksCard">
              <a
                className="aCardLink"
        ...
        <div className="cardInner">
          ...
          <div data-testid="petBack" className="cardBack">
            <p className="projectPhar">
              ...
              take it for a walk to get back its fitness and of course feed it.
              However, nature is cruel and even if you take care of it on the
              best way the pet will D-I-E when it reaches 30 years.
            </p>
            <div className="linksCard">
              <a
                className="aCardLink"
